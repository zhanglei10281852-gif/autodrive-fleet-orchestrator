...
func (s *Store) CommitTelemetry(ctx context.Context, commit repository.TelemetryCommit) (bool, error) {
	return s.CommitTelemetrySample(ctx, commit)
}

func (s *Store) CommitTelemetrySample(ctx context.Context, commit repository.TelemetryCommit) (bool, error) {
	duplicate := false
...
func (s *Store) CommitTelemetryIncident(ctx context.Context, commit repository.TelemetryCommit) error {
